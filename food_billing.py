...
lblTitle=Label(Tops,font=('arial',60,'bold'),text='Food Billing System',bd=21,bg='skyblue',
...
Cal_F=Frame(ReceiptCal_F,bg='yellow',bd=6,relief=RIDGE)
Cal_F.pack(side=TOP)
...
def CostofItem():
    ...
    PriceofDrinks =(Item1 * 30) + (Item2 * 45) + (Item3 * 35) + (Item4 * 100) + (Item5 * 140) + (Item6 * 75) + (Item7 * 75) + (Item8 * 89)

    PriceofFood =(Item9 * 260) + (Item10 * 175) + (Item11 * 125) + (Item12 * 480) + (Item13 * 240) + (Item14 * 110) + (Item15 * 340) + (Item16 * 213)
